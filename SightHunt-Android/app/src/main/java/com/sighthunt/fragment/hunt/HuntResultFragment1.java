...
public class HuntResultFragment1 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		final View view = inflater.inflate(R.layout.fragment_hunt_result1, container, false);
	...
	public static HuntResultFragment1 createInstance(Sight sight, float lon, float lat) {
		HuntResultFragment1 fragment = new HuntResultFragment1();
